...
Aqui analiso como o Garbage Collector e o Event Loop se comportam sob estresse, garantindo que o software permaneça estável e rápido após dias de execução ininterrupta.

### 🎯 Linhas de Pesquisa:
- **Memory Lifecycle Audit:** Monitoramento de coleta de objetos (WeakRef) para prevenir memory leaks silenciosos.
- **Event Loop Latency Analysis:** Análise de microtasks para priorizar a interatividade da UI.
- **V8 Optimization Patterns:** Escrita de código otimizado para o compilador JIT (Just-In-Time) do navegador.

---

## 🇺🇸 Runtime Diagnostics & Low-Level Research
